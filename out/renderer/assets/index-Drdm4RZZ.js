...
function App() {
  ...
  const handleSubmit = (event) => {
    ...
    if (file) {
      ...
      window.electron.ipcRenderer.once("parse-file-response", (event2, response) => {
        if (response.success) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "App", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ...getRootProps(), className: `dropzone ${isDragActive ? "active" : ""}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ...getInputProps() }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Drop the PDF file here ..." })
      ] }),
      file && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "Selected file: ",
        file.name
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", disabled: !file, style: { marginRight: "20px" }, children: "Parse Statement" }),
    ...
    result && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Result:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: result })
    ] }),
    errors.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Parsing Errors:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: errors.map((error, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: error }, index)) })
    ] })
  ] });
}
